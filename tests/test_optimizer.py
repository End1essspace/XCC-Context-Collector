...
def test_compact_generated_text_removes_repeated_empty_lines() -> None:
    ...
    result = compact_generated_text(text)

    assert result == "a\n\nb\n\nc\n"


def test_compact_generated_text_strips_trailing_spaces() -> None:
    text = "a   \n b   \n"
...
def test_compact_generated_text_keeps_single_final_newline() -> None:
    result = compact_generated_text("a")
