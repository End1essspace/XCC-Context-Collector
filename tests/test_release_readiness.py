...
def _write_report(
    ...
    *,
    version: str = "1.4.0",
    archive_name: str = "XCC-Context-Collector-v1.4.0-win64.zip",
...
def test_automated_gate_report_matches_final_archive(tmp_path: Path) -> None:
    ...
    archive_name = "XCC-Context-Collector-v1.4.0-win64.zip"
    archive_hash = "b" * 64
    _write_report(
        report,
